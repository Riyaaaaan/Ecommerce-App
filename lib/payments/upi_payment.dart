...
class UpiPaymentsPage extends StatefulWidget {
  ...
  UpiPaymentsPage({Key? key, required this.totalAmount}) : super(key: key);
...
class _UpiPaymentsPageState extends State<UpiPaymentsPage> {
  ...
  Future<UpiResponse> initiateTransaction(UpiApp app) async {
    return _upiIndia.startTransaction(
      app: app,
      receiverUpiId: "riyanriyu1234-1@okaxis",
      receiverName: 'Muhammed Riyan',
    ...
    switch (status) {
      case UpiPaymentStatus.SUCCESS:
        ...
        Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => LottieAnime()));
        break;
